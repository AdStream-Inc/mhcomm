      ...
      <div class="well clearfix">
        ...
        <div class="media">
          <a class="pull-left" href="#">
            <img width="150" class="media-object img-responsive img-thumbnail" src="{{ $community->main_image }}">
          </a>
          <div class="media-body">
            {{ Form::bootwrapped('main_image_file', 'New Main Image', function($name){
                return Form::file($name, array('class' => 'form-control'));
              })
            }}
          </div>
        </div>
